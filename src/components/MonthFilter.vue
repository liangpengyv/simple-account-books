...
<template>
  <div class="month-filter">
    <n-button class="jump-button" text :disabled="props.disabled || prevMonthCurrent < EARLIEST_DATE.getTime()"
    ...
    <n-date-picker :value="props.value" :disabled="props.disabled" type="month" input-readonly
      :is-date-disabled="current => (current > Date.now() || current < EARLIEST_DATE.getTime())"
      @update:value="value => emit('update:value', value)">
    </n-date-picker>

    <n-button class="jump-button" text :disabled="props.disabled || nextMonthCurrent > Date.now()"
